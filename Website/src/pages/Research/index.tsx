...
const ResearchSection = () => {
  ...
  return (
      ...
      <section className=" text-DarkBackground py-16 px-6 md:px-12 lg:px-20 flex flex-col gap-20">
        <div className='flex flex-col md:flex-row' >
            ...
            <div className="w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-4xl md:text-5xl font-bold font-heading text-DarkBackground mb-6"> Our <span className="text-lime-500"> Innovation </span> </h2>
        ...
        <div className='flex flex-col md:flex-row' >
            ...
            <div className="w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-4xl md:text-5xl font-bold font-heading text-DarkBackground mb-6"> Our <span className="text-lime-500"> Farms </span> </h2>
              <p className="text-Hydrocarbon mb-6 font-body">
                We are a leading agricultural company dedicated to revolutionizing modern farming practices. Our mission is to empower farmers with innovative solutions that enhance productivity, sustainability, and profitability. With a strong commitment to research and development, we provide cutting-edge technologies and services tailored to meet the evolving needs of the agricultural industry.
              </p>
              <p className="text-Hydrocarbon mb-6 font-body">
        ...
        <div className='flex  flex-col md:flex-row' >
            ...
            <div className="w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-4xl md:text-5xl font-bold font-heading text-DarkBackground mb-6"> Facility <span className="text-lime-500"> We Provide </span> </h2>
              <p className="text-Hydrocarbon mb-6 font-body">
                We are a leading agricultural company dedicated to revolutionizing modern farming practices. Our mission is to empower farmers with innovative solutions that enhance productivity, sustainability, and profitability. With a strong commitment to research and development, we provide cutting-edge technologies and services tailored to meet the evolving needs of the agricultural industry.
              </p>
              <p className="text-Hydrocarbon mb-6 font-body">
        ...
        <div className='flex flex-col md:flex-row' >
            ...
            <div className="w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-4xl md:text-5xl font-bold font-heading text-DarkBackground mb-6"> Our <span className="text-lime-500"> Breeder working </span> </h2>
              <p className="text-Hydrocarbon mb-6 font-body">
                We are a leading agricultural company dedicated to revolutionizing modern farming practices. Our mission is to empower farmers with innovative solutions that enhance productivity, sustainability, and profitability. With a strong commitment to research and development, we provide cutting-edge technologies and services tailored to meet the evolving needs of the agricultural industry.
              </p>
              <p className="text-Hydrocarbon mb-6 font-body">
