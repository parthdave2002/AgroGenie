...
const  Termspagesection = () => {
  ...
  return (
    <div className='py-6 px-6 md:px-12 lg:px-24 max-w-1600 mx-auto'>

      <div className="flex justify-center w-full px-4">
        <div className="flex flex-wrap justify-center bg-gray-200 rounded-xl overflow-hidden w-full sm:w-auto">
          {tabs.map((tab, index) => (
            <button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-md font-medium transition-colors duration-300   ${activeTab === tab.id ? "bg-lime-500 text-white" : "text-gray-700 hover:bg-gray-300"}  ${index === 0 ? "rounded-l-xl" : ""}  ${index === tabs.length - 1 ? "rounded-r-xl" : ""}`} >  {tab.label} </button>
          ))}
        </div>
      </div>
       ...
       <div className="w-full  mt-8 text-gray-700">
        {activeTab === "terms" && (
          ...
          <div className='font-body'>
            ...
            <p className='mb-2 font-semibold  text-[1.2rem]'>1. General Use of Website </p>
            <p className='text-[1rem] font-semibold '>a. Eligibility </p>
            ...
            <p className=' text-[1rem] font-semibold '>b. Informational Purpose  </p>
            ...
            <p className='mb-2 font-semibold  text-[1.2rem]'>2. Products and Services </p>
            <p className='text-[1rem] font-semibold'>a. Product Availability </p>
            ...
            <p className='text-[1rem] font-semibold'>b. Pricing  </p>
            ...
            <p className='text-[1rem] font-semibold'>c. Orders  </p>
            ...
            <p className='mb-2 font-semibold  text-[1.2rem]'>3. Delivery & Shipping </p>
            <p className='text-[1rem] font-semibold'>a. Delivery Areas </p>
            ...
            <p className=' text-[1rem] font-semibold'>b. Delivery Timelines </p>
            ...
            <p className=' text-[1rem] font-semibold'>c. Delays  </p>
            ...
            <p className='mb-2 font-semibold  text-[1rem]'>4. Returns, Refunds, and Cancellations</p>
            <p className='text-[1rem] font-semibold'>a. Return Policy </p>
            ...
            <p className=' text-[1rem] font-semibold'>b. Refunds</p>
            ...
            <p className='text-[1rem] font-semibold'>c. Order Cancellations </p>
            ...
            <p className='mb-2 font-semibold  text-[1rem]'>5. Payments</p>
            <p className='text-[1rem] font-semibold'>a. Accepted Methods </p>
            ...
            <p className='text-[1rem] font-semibold'>b. Payment Security</p>
            ...
            <p className='font-semibold  text-[1rem]'> 6. User Responsibilities</p>
            ...
            <p className=' text-[1rem] font-semibold'>7. Intellectual Property </p>
            ...
            <p className='text-[1rem] font-semibold'>8. Third-Party Links </p>
            ...
            <p className='text-[1rem] font-semibold'>9. Account Termination</p>
            ...
            <p className='text-[1rem] font-semibold'>10. Limitation of Liability</p>
            ...
            <p className='text-[1rem] font-semibold'>11. Governing Law & Jurisdiction</p>
            ...
            <p className='text-[1rem] font-semibold'>12. Modifications to Terms</p>
            ...
            <p className='text-[1rem] font-semibold'>13. Contact Information</p>
        ...
        {activeTab === "privacy" && (
          <div className='font-body'>
            ...
            <p className='mb-2 font-semibold text-[1rem]'>1. Information We Collect </p>
            ...
            <p className='mb-2 font-semibold text-[1rem]'>2. How We Use Your Information </p>
            ...
            <p className='mb-2 font-semibold text-[1rem]'>3. Data Protection & Security</p>
            ...
            <p className='mb-2 font-semibold text-[1rem]'>4. Sharing with Third Parties</p>
            ...
            <p className='font-semibold text-[1rem]'>5. User Rights</p>
            ...
            <p className='font-semibold text-[1rem]'>6. Policy Updates</p>
            ...
            <p className='font-semibold text-[1rem]'>7. Children’s Privacy</p>
            ...
            <p className='font-semibold text-[1rem]'>13. Contact Information</p>
        ...
        {activeTab === "return" && (
         <div className='font-body'>
            ...
            <h2 className="text-[1.5rem] md:text-[2rem]  font-semibold my-5"> Return & Refund </h2>
            ...
            <p className='font-semibold text-[1rem]'>1. Order Cancellation</p>
            ...
            <p className=' font-semibold text-[1rem]'>2. Refund Policy (For Online Payments)</p>
            ...
            <p className=' font-semibold text-[1rem]'>3. Replacement Policy (For Damaged or Defective Products)</p>
            ...
            <p className=' font-semibold text-[1rem]'>4. Customer Change of Mind (No Longer Wants the Product)</p>
            ...
            <p className=' font-semibold text-[1rem]'>5. How to Contact Us</p>
