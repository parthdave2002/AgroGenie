        ...
        <div className="md:flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="w-full sm:w-auto flex flex-col sm:flex-row sm:items-center sm:justify-end gap-4 mt-4 sm:mt-0">
            <ul className="flex items-center justify-center gap-x-3">
                ...
                <div>
                  <button onClick={() => OpenBrochure()} className="flex items-center bg-orange-600 rounded-full px-4 py-2 space-x-2 hover:bg-orange-500 hover:scale-105 hover:shadow-lg transition-all duration-200">
