...
const BrandCarouselSection: React.FC = () => {
  ...
  return (
      ...
      <div className="relative max-w-1600 mx-auto px-4"  >
        <h2 className="text-4xl md:text-5xl font-bold font-heading text-DarkBackground my-5 flex justify-center "> Our <span className="text-lime-500"> Seeds </span> </h2>
              ...
              {brandData.map((item, index) => (
                <div key={index} className="flex-shrink-0 w-32 md:w-48 mx-5 flex items-center text-center justify-center">
                  <div className='flex flex-col '>
                    ...
                    {/* <h3 className="text-base font-semibold text-DarkBackground mt-2 leading-tight">{item.subtitle}</h3> */}
                  </div>
                </div>
              ))}
            </Marquee>
