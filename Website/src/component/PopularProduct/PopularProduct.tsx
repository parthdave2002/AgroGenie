    ...
    <section className="py-10 overflow-hidden">
      <div className="max-w-1600 mx-auto px-4">
        <div className=" md:flex justify-center items-center mb-6">
          {/* <h2 className="text-2xl font-heading md:text-3xl font-semibold">{t("  products")}</h2> */}
          <h2 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 my-5 flex justify-center gap-x-3"> Our Most <span className="text-lime-500">  Popular Product</span> </h2>
