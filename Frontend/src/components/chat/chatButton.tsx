...
const ChatButton = () => {
  ...
  if (!userId || !token) {
    return (
      <div className="fixed bottom-4 right-4 z-50 rounded-full bg-Hydrocarbon px-5 py-3 text-sm font-semibold text-White shadow-xl">
        Login required
      </div>
    );
  }
            ...
            <div className="flex-1 bg-White">
              {openProfileModal ? (
                ...
                <div className="flex h-full flex-col items-center justify-center gap-4 px-6 text-center text-slate-500">
                  <div className="rounded-3xl bg-TitaniumWhite px-6 py-5 text-sm shadow-sm">
