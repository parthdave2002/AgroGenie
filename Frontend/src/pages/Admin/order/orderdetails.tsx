  ...
  return (
    <>
      <NavbarSidebarLayout   isSidebar={true} isNavbar={true}   >
        ...
        <div className="mt-[2rem] bg-TitaniumWhite dark:bg-Cosmos p-4">
                ...
                >
                  ...
                  {pageIndex === productChunks.length - 1 && (
                    <>
                      ...
                      <div className="text-2xl font-bold bg-TranquilBlack text-White px-3 py-2  text-right  leading-tight antialiased">Total : ₹{total ? Math.round(total) : 0}</div>
