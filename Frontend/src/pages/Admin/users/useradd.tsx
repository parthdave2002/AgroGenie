...
const AddUserPage : FC = function () {
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            mobile_no: Yup.string().required("Please Enter Mobile Number").matches(/^\d{10}$/, "Mobile number must be 10 digits"),
            address: Yup.string().required("Please Enter Address"),
            emergency_mobile_no: Yup.string().required("Please Enter Emergency Mobile Number").matches(/^\d{10}$/, "Mobile number must be 10 digits"),
                        ...
                        <div className="md:flex  gap-x-[2rem]">
                            ...
                            <div  className="flex-1 mt-[1rem]">
                                <Inputbox
                                    id="mobile_no"
                                    name="mobile_no"
                                    label="Advisor Mobile no"
                                    required={true}
                                    placeholder="Advisor Mobile no"
                                    type="number"
                                    validation={validation}
                                />
                            </div>
                        ...
                        <div className="md:flex gap-x-[2rem]">
                            ...
                            <div className="flex-1 mt-[1rem]">
                                <Inputbox
                                    ...
                                    label="Date of birth"
                                    required={true}
                                    placeholder="Advisor Date of birth"
                                    type="date"
                                    validation={validation}
                            ...
                            <div  className="flex-1 mt-[1rem]">
                                <Inputbox
                                    ...
                                    required={true}
                                    placeholder="Advisor Date of joining"
                                    type="date"
                                    validation={validation}
                                />
                            </div>
